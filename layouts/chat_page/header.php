...
<head>
    ...
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/bootstrap/bootstrap.min.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/animate/animate.min.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/videojs/video-js.min.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/videojs/city.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/viewerjs/viewer.min.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/colorpicker/dist/css/bootstrap-colorpicker.min.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/summernote/summernote-lite.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/thirdparty/bootstrap-icons/bootstrap-icons.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/main.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/side_navigation.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/aside.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/middle.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/info_panel.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/statistics.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/audio_player_box.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/form.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/loader.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/popup-dialog.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/responsive.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/chat_page/rtl_language.css'.$cache_timestamp; ?>" rel="stylesheet">
    
    <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
    
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/common/scroll.css'.$cache_timestamp; ?>" rel="stylesheet">
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/common/custom_css.css'.$cache_timestamp; ?>" rel="stylesheet">
