...
$('body').on('click', '.load_form', function(e) {
    ...
    $('input[class="field custom_field_11"]').autocomplete({
        ...
        onSelect: function(suggestion) {
            // console.log('You selected: ' + suggestion.value + ', ' + suggestion.latitude + ', ' + suggestion.longitude + ',' + suggestion.geo_id);
            // $('#selction-ajax').html('You selected: ' + suggestion.value + ', ' + suggestion.latitude + ', ' + suggestion.longitude);
            location_id = suggestion.geo_id;
                    ...
                    $.each(fields, function(key, val) {
                        ...
                        if (field.tag == 'input' && field.type == 'date') {
                            ...
                            if (field.class !== undefined) {
                                console.log(field.class,attribute,attributes);
                                form = form + '<'+field.tag+' name="'+key+'" class ="'+field.class+'" type="'+field.type+'" '+attribute+' '+attributes+' autocomplete="off"/>';
                            } else {
